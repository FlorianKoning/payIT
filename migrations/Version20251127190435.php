 ...
 */
final class Version20251127190435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE merchant ADD CONSTRAINT FK_74AB25E19D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_74AB25E19D86650F ON merchant (user_id_id)');
        $this->addSql('ALTER TABLE payment_method ADD user_id_id INT NOT NULL, ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7B61A1F6A76ED395 ON payment_method');
        $this->addSql('ALTER TABLE payment_method DROP user_id_id, DROP user_id');
    }
}
